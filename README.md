...
| 4 | Есть доступ к [БД](https://WBBDTEST.ru) (Логин / пароль :  Admin / 987654)  |
...
#### ***Ожидаемый результат***
В базе данных в таблице “create_order” есть новая запись о созданном заказе. На странице оформления заказа есть информация о:
- Адресе пиццерии, выбранном в шаге 12;
- Способе оплаты, выбранном в шаге 13;
- Составе заказа: пицца из половинок, указанных в шагах 6 и 7;
- Номере заказа.
